...
@Controller
public class BuscarPorControllerAdmin {
    @Autowired
    ...
    @GetMapping("/admin/productos/descripcion")
    public String mostrarFormularioDescripcion(Model model){
        model.addAttribute("titulo", "Buscar Productos Por Descripción");
        return "buscar-descripcion-admin";
    }

    @PostMapping("/admin/productos/descripcion/resultados")
    public String buscarResultadosPorDescripcion(@RequestParam("descripcion") String descripcion, Model model) {
        ...
        if (productosEncontrados.isEmpty()) {
            ...
            model.addAttribute("direccion", "/admin/productos/descripcion");
            ...
            return "resultado-descripcion-admin"; // Vista para mostrar los resultados
        }
    }

    @GetMapping("/admin/productos/marca")
    public String mostrarFormularioMarca(Model model) {
        ...
        return "buscar-marca-admin";
    }

    @PostMapping("/admin/productos/marca/resultados")
    public String buscarPorMarca(@RequestParam("marca") Long idMarca, Model model) {
        ...
        if (productosEncontrados.isEmpty()) {
            ...
            model.addAttribute("titulo", "Error");
            model.addAttribute("mensaje", mensaje);
            model.addAttribute("direccion", "/admin/productos/marca");
            ...
            return "resultado-marca-admin";
        }
    }

    @GetMapping("/admin/productos/categoria")
    public String mostrarFormularioCategoria(Model model) {
        ...
        return "buscar-categoria-admin";
    }

    @PostMapping("admin/productos/categoria/resultados")
